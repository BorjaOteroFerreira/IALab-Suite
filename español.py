...
class LlamaAssistant:
    def __init__(self, model_path):
        ...
        self.mensaje_sistema = "Eres un asistente  que solo sabe hablar en español"
    ...
    def get_assistant_response(self):
        ...
        output = self.llm.create_chat_completion(messages=self.conversation_history, max_tokens=512)
        print(output)
